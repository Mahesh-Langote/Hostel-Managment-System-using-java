...
public class attendanceStudent_ extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("select*from studentDetails where roomNumber='" + mobailNumber + "' and status='Living'");
            if (rs.first()) {
